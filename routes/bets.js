...
router.post('/request-unlock', auth_1.authMiddleware, async (req, res) => {
    try {
        ...
        const adminPanelUrl = 'https://hr.prodecaballito.com/admin';
...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background:#f3f4f6">
  <div style="max-width:600px;margin:0 auto;padding:20px">
    <div style="background:linear-gradient(135deg,#0042A5,#001A4B);padding:30px;text-align:center;border-radius:12px 12px 0 0">
      <h1 style="color:white;margin:0;font-size:24px">⚽ PRODE High Rolling</h1>
    </div>
    <div style="background:white;padding:30px;border-radius:0 0 12px 12px;box-shadow:0 4px 6px rgba(0,0,0,.1)">
      ...
      <p style="color:#9CA3AF;font-size:12px;text-align:center;margin-top:20px">
        © 2026 PRODE High Rolling — Este es un email automático
      </p>
    </div>
  </div>
</body>
...
<body style="margin:0;padding:0;font-family:Arial,sans-serif;background:#f3f4f6">
  <div style="max-width:600px;margin:0 auto;padding:20px">
    <div style="background:linear-gradient(135deg,#0042A5,#001A4B);padding:30px;text-align:center;border-radius:12px 12px 0 0">
      <h1 style="color:white;margin:0">⚽ PRODE High Rolling</h1>
    </div>
    <div style="background:white;padding:30px;border-radius:0 0 12px 12px">
      ...
      <div style="text-align:center;margin:25px 0">
        <a href="https://hr.prodecaballito.com/matriz"
