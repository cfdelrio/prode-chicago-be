        ...
        if (process.env.ENGAGE_ENABLED === 'true') {
            ...
            if (p.whatsapp_number && p.whatsapp_consent) {
                sendSMSWithRetry({
                    ...
                    body: `💸 "${p.nombre_planilla}" para ${p.torneo_name} sigue sin pagar. Arrancan en ${daysLeft} día${daysLeft === 1 ? '' : 's'}. 👉 hr.prodecaballito.com/planillas`,
  ...
  <tr><td align="center" style="padding:32px 16px;">
    <table width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);">
      <tr><td style="background-color:#7C2D12;padding:32px 32px 24px;text-align:center;">
        ...
        <p style="margin:0;font-size:13px;color:#FDBA74;font-family:Arial,sans-serif;">PRODE High Rolling</p>
      </td></tr>
      <tr><td style="background-color:#FFFFFF;padding:32px 32px 28px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr><td align="center">
            <a href="https://hr.prodecaballito.com/planillas" style="display:inline-block;background-color:#EA580C;color:#FFFFFF;text-decoration:none;font-family:Arial,sans-serif;font-size:14px;font-weight:bold;padding:14px 36px;border-radius:50px;">Confirmar pago →</a>
          </td></tr>
        </table>
      </td></tr>
